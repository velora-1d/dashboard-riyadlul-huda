...
<?php $__env->startSection('page-title', 'Pemasukan'); ?>
    ...
    <div style="display: grid; grid-template-columns: 1fr; gap: 32px;">
        <div style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; overflow: hidden;">
            ...
            <div style="padding: 24px;">
                <form method="POST" action="<?php echo e(route('bendahara.pemasukan.store')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div style="overflow-x: auto;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody style="font-size: 0.9375rem;">
                        <?php $__empty_1 = true; $__currentLoopData = $pemasukan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr id="row-<?php echo e($p->id); ?>" style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;">
                                ...
                                <td style="padding: 16px 24px; text-align: center;">
                                    <div style="display: flex; justify-content: center; gap: 8px;">
                                        ...
                                        <form method="POST" action="<?php echo e(route('bendahara.pemasukan.destroy', $p->id)); ?>" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                            <?php echo csrf_field(); ?>
                            ...
                            <tr id="edit-<?php echo e($p->id); ?>" style="display: none; background: #f8fafc;">
                                <td colspan="6" style="padding: 24px; border-bottom: 1px solid #e2e8f0;">
                                    <form method="POST" action="<?php echo e(route('bendahara.pemasukan.update', $p->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 20px;">
                                            <div>
                                                ...
                                                <input type="text" name="sumber_pemasukan" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 0.875rem;" value="<?php echo e($p->sumber_pemasukan); ?>" required>
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <select name="kategori" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 0.875rem;" required>
                                                    <option value="donasi" <?php echo e($p->kategori == 'donasi' ? 'selected' : ''); ?>>Donasi</option>
                                                    <option value="syahriah" <?php echo e($p->kategori == 'syahriah' ? 'selected' : ''); ?>>Syahriah</option>
                                                    <option value="kantin" <?php echo e($p->kategori == 'kantin' ? 'selected' : ''); ?>>Kantin / Usaha</option>
                                                    <option value="program" <?php echo e($p->kategori == 'program' ? 'selected' : ''); ?>>Program Khusus</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\dashboard-riyadlul-huda\resources\views\bendahara\pemasukan\index.blade.php ENDPATH**/ ?>