...
<?php $__env->startSection('title', 'Rekapitulasi Nilai Ujian'); ?>
<?php $__env->startSection('page-title', 'Rekapitulasi Nilai Ujian'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="background: linear-gradient(135deg, #ff9800 0%, #f57c00 100%); border-radius: 10px; padding: 16px 24px; margin-bottom: 20px; box-shadow: 0 4px 12px rgba(255,152,0,0.25);">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('pendidikan.nilai')); ?>" id="filterForm">
    ...
    <?php if(request('kelas_id')): ?>
        ...
        <div style="background: linear-gradient(135deg, #ff9800 0%, #f57c00 100%); color: white; padding: 16px; text-align: center; border-radius: 8px 8px 0 0; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
            <h3 style="margin: 0; font-size: 18px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">
                NILAI UJIAN SEMESTER - KELAS <?php echo e($kelas->nama_kelas); ?>

            </h3>
            <p style="margin: 4px 0 0 0; font-size: 13px; opacity: 0.9;">
                Semester <?php echo e($semester == '1' ? 'Ganjil' : 'Genap'); ?> - <?php echo e($tahunAjaran); ?>
        ...
        <!-- Table Form -->
        <form method="POST" action="<?php echo e(route('pendidikan.nilai.store-bulk')); ?>" id="nilaiForm">
            <?php echo csrf_field(); ?>
                    ...
                    <table style="width: max-content; border-collapse: collapse; font-size: 11px; min-width: 100%;">
                        <thead>
                            ...
                            <tr class="excel-header-main">
                                ...
                                <?php $__currentLoopData = $displayMapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $santriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="santri-row <?php echo e($index % 2 == 0 ? 'row-even' : 'row-odd'); ?>">
                                    ...
                                    <td class="sticky-nama" style="padding: 6px 8px;">
                                        ...
                                        <strong style="color: #1e3a5f; font-size: 11px;"><?php echo e($santri->nama_santri); ?></strong>
                                    </td>
                                    ...
                                    <?php $__currentLoopData = $displayMapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="col-semester" style="padding: 4px; text-align: center;">
                                            <input type="number" 
                                                   name="santri[<?php echo e($index); ?>][mapel][<?php echo e($mapel->id); ?>]" 
                                                   class="nilai-input inp-sem-<?php echo e($mapel->id); ?>"
                                                   data-mapel-id="<?php echo e($mapel->id); ?>"
                                                   data-weekly-score="<?php echo e($weeklyScore); ?>"
                                                   data-has-weekly="<?php echo e($hasWeekly ? 'true' : 'false'); ?>"
                                                   value="<?php echo e($nilai ? $nilai->nilai_ujian_semester : ''); ?>" 
                                        ...
                                        <td class="col-mingguan" style="padding: 4px; text-align: center; font-size: 11px;">
                                            <?php if($hasWeekly): ?>
                                                <span class="val-week-<?php echo e($mapel->id); ?>" style="font-weight: 600; color: #1e3a5f;"><?php echo e(number_format($weeklyScore, 0)); ?></span>
                                            <?php else: ?>
                                                <span class="val-week-<?php echo e($mapel->id); ?>" style="color: #999;">-</span>
                                            <?php endif; ?>
                                        </td>
                                        
                                        
                                        <td class="asli-cell-<?php echo e($mapel->id); ?> col-final" style="padding: 4px; text-align: center;">
                                            <strong class="val-final-<?php echo e($mapel->id); ?>" style="font-size: 11px;">-</strong>
                                        </td>
                                        
                                        
                                        <td class="rapor-cell-<?php echo e($mapel->id); ?> col-rapor" style="padding: 4px; text-align: center;">
                                            <strong class="val-rapor-<?php echo e($mapel->id); ?>" style="font-size: 11px;">-</strong>
                                        </td>
                                        
                                        
                                        <td class="source-cell-<?php echo e($mapel->id); ?> col-sumber" style="padding: 4px; text-align: center;">
                                    ...
                                    <td class="jumlah-cell sticky-jumlah" style="padding: 8px; text-align: center; border-right: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0; font-weight: 700; font-size: 12px;">
                                        <?php echo e(number_format($jumlah, 1)); ?>
                                    ...
                                    <td class="rata-cell sticky-rata" style="padding: 8px; text-align: center; border-right: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0; font-weight: 700; font-size: 12px;">
                                        <?php echo e(number_format($rataRata, 2)); ?>

                                    </td>
                                    
                                    
                                    <td class="rank-cell sticky-rank" style="padding: 8px; text-align: center; border-bottom: 1px solid #e2e8f0; font-weight: 700; font-size: 12px;" data-rata="<?php echo e($rataRata); ?>" data-santri-id="<?php echo e($santri->id); ?>">
                                        -
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tfoot style="position: sticky; bottom: 0; z-index: 50;">
                            <tr class="excel-footer">
                                ...
                                <?php $__currentLoopData = $displayMapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="footer-avg-sem-<?php echo e($mapel->id); ?>" style="padding: 6px; text-align: center; font-size: 11px;">0</td>
                                    <td class="footer-avg-week-<?php echo e($mapel->id); ?>" style="padding: 6px; text-align: center; font-size: 11px; color: #94a3b8;">0</td>
                                    <td class="footer-avg-final-<?php echo e($mapel->id); ?>" style="padding: 6px; text-align: center; font-size: 11px; color: #60a5fa;">0</td>
                                    <td class="footer-avg-rapor-<?php echo e($mapel->id); ?>" style="padding: 6px; text-align: center; font-size: 11px; color: #fb923c;">0</td>
