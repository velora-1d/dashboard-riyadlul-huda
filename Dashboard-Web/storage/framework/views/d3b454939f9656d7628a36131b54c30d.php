...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($kelas->tingkat); ?></td>
            </tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($asrama->id); ?></td>
                <td><?php echo e($asrama->nama_asrama); ?></td>
                <td><?php echo e($asrama->gender); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\dashboard-riyadlul-huda\resources\views\sekretaris\template-import-excel.blade.php ENDPATH**/ ?>