...
<?php $__env->startSection('title', 'Kartu Digital'); ?>
<?php $__env->startSection('page-title', 'Kartu Syahriah Digital'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="background: white; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        <form method="GET" action="<?php echo e(route('sekretaris.kartu-digital')); ?>" style="display: flex; gap: 16px; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 200px;">
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Nama / NIS..." style="width: 100%; padding: 10px 14px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 16px;">
                            <div style="font-weight: 600; color: #1e293b;"><?php echo e($santri->nama_santri); ?></div>
                            <div style="font-size: 12px; color: #64748b;"><?php echo e($santri->nis); ?></div>
                        </td>
                        <td style="padding: 16px;">
                            <span style="font-size: 13px; color: #475569;">
                                <?php echo e($santri->kelas->nama_kelas ?? '-'); ?> - Kobong <?php echo e($santri->kobong->nomor_kobong ?? '-'); ?>
                        ...
                        <td style="padding: 16px; text-align: center;">
                            <?php if($santri->virtual_account_number): ?>
                                <div style="display: flex; justify-content: center; gap: 8px;">
                                    <a href="#" onclick="openPreviewModels('<?php echo e(route('sekretaris.kartu-digital.preview', $santri->id)); ?>')" 
                                    ...
                                    <a href="<?php echo e(route('sekretaris.kartu-digital.download', $santri->id)); ?>" target="_blank" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\dashboard-riyadlul-huda\resources\views\sekretaris\kartu-digital\index.blade.php ENDPATH**/ ?>