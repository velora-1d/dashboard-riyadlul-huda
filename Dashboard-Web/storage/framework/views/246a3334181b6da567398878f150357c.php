...
<head>
    ...
    <title>Cetak Nilai - <?php echo e($kelas->nama_kelas); ?></title>
    <style>
        @page {
            size: landscape;
            margin: 1cm;
...
<body>
    ...
    <div class="header">
        ...
        <p>Kelas: <?php echo e($kelas->nama_kelas); ?> | Semester: <?php echo e($semester == 1 ? 'Ganjil' : 'Genap'); ?> | Tahun Ajaran: <?php echo e($tahunAjaran); ?></p>
        <?php if($gender && $gender !== 'all'): ?>
            <p style="font-style: italic;">Filter: <?php echo e(ucfirst($gender)); ?></p>
        <?php endif; ?>
    </div>
    ...
    <table class="nilai-table">
        <thead>
            <tr>
                ...
                <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <th style="min-width: 45px;"><?php echo e($mapel->nama_mapel); ?></th>
        ...
        <tbody>
            <?php $__currentLoopData = $santriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="no-col"><?php echo e($index + 1); ?></td>
                    <td class="student-name"><?php echo e($santri->nama_santri); ?></td>
                    <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <?php if(isset($nilaiData[$santri->id][$mapel->id]) && $nilaiData[$santri->id][$mapel->id]): ?>
                                <?php echo e(number_format($nilaiData[$santri->id][$mapel->id], 1)); ?>
                    ...
                    <td style="background-color: #fff9e6; font-weight: bold;">
                        <?php echo e($studentAverages[$santri->id]['total'] > 0 ? number_format($studentAverages[$santri->id]['total'], 1) : '-'); ?>

                    </td>
                    <td style="background-color: #f0f8f0; font-weight: bold;">
                        <?php echo e($studentAverages[$santri->id]['average'] > 0 ? number_format($studentAverages[$santri->id]['average'], 2) : '-'); ?>

                    </td>
                    <td style="background-color: #fff0f0;" class="<?php echo e($studentRankings[$santri->id] <= 3 ? 'rank-' . $studentRankings[$santri->id] : ''); ?>">
                        <?php if($studentAverages[$santri->id]['average'] > 0): ?>
                            <?php echo e($studentRankings[$santri->id]); ?>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e($columnStats[$mapel->id]['sum'] > 0 ? number_format($columnStats[$mapel->id]['sum'], 1) : '-'); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td colspan="3" style="background-color: #e3f2fd;">
                    <?php echo e(collect($columnStats)->sum('sum') > 0 ? number_format(collect($columnStats)->sum('sum'), 1) : '-'); ?>
            ...
            <tr>
                ...
                <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e($columnStats[$mapel->id]['average'] > 0 ? number_format($columnStats[$mapel->id]['average'], 2) : '-'); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td colspan="3" style="background-color: #fff3e0;">
                    <?php
                        $totalAvg = collect($columnStats)->avg('average');
                    ?>
                    <?php echo e($totalAvg > 0 ? number_format($totalAvg, 2) : '-'); ?>
    ...
    <div class="footer">
        ...
        <div class="signature-box">
            <p><?php echo e(now()->locale('id')->translatedFormat('d F Y')); ?></p>
