        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $santriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td><?php echo e($talaran->minggu_3 ?? 0); ?></td>
                    <td><?php echo e($talaran->minggu_4 ?? 0); ?></td>
                    <td><b><?php echo e($talaran->jumlah ?? 0); ?></b></td>
                    <td><?php echo e($talaran->tamat ?? 0); ?></td>
                    <td class="bg-red"><?php echo e($talaran->alfa ?? 0); ?></td>
                    <td><?php echo e($talaran->total ?? '-'); ?></td>
                    <td class="text-alfa"><?php if(($talaran->alfa ?? 0) > 0): ?> ALFA <?php echo e($talaran->alfa); ?> <?php endif; ?></td>
                </tr>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\dashboard-riyadlul-huda\resources\views\pendidikan\talaran\pdf\full.blade.php ENDPATH**/ ?>