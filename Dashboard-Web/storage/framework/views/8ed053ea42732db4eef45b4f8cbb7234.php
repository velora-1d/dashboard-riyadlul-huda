...
<head>
    ...
    <title>Kartu Syahriah Digital - <?php echo e($santri->nama_santri); ?></title>
    <style>
        @page {
            margin: 0;
            padding: 0;
...
<body>
    <div class="card-wrapper">
        <div class="card">
            ...
            <!-- LOGO PESANTREN -->
            <img src="<?php echo e(public_path('images/logo-yayasan.png')); ?>" class="logo-school" alt="Logo">
            ...
            <div class="content">
                ...
                <div class="va-number">
                    <?php echo e(chunk_split($santri->virtual_account_number ?? '00000000', 4, ' ')); ?>
            ...
            <div class="santri-info">
                ...
                <div class="name"><?php echo e($santri->nama_santri); ?></div>
            </div>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\dashboard-riyadlul-huda\resources\views\sekretaris\kartu-digital\pdf.blade.php ENDPATH**/ ?>